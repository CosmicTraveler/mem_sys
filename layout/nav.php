        ...
        <div class="nav-icons">
            <a href="index.php">
                <div class="icon-wrapper relative">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="50px" hieght="50px"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
            ...
            <a href="register.php">
                <div class="icon-wrapper relative">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" width="50px" hieght="50px"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
